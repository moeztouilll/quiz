    ...
    "messages": [
        {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "Extract the matching question data from this image. Return the answer in pure JSON format: a list of dictionaries with 'left' (the item to drag) and 'right' (the correct destination it belongs to)."
                },
                {
                    "type": "image_url",
                    "image_url": {
